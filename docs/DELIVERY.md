...
- 228 个 Rust 库测试通过，0 failed/ignored。
- 24 个隔离与安全脚本测试通过，前端 lint/build、核心文件格式检查和 Mac `cargo check --locked --lib` 通过。
...
- DMG：`artifacts/macos/c73efd374a3be124b1e278866cf366b5e911df4d/MyKVM Local_0.1.3_aarch64.dmg`
- DMG SHA-256：`be0c1c93747b68c52b2a61e98e98047da21dfeaf3aa44cee4dc0a64553660c72`
- 主程序 SHA-256：`128fbf65594a21f647660eca269d1a7f606d13a6641211dd01fc5b74843fe7a0`
- 架构/版本/标识：Mach-O arm64，`0.1.3`，`local.mykvm.gaming`
...
- 本地安装包：`artifacts/windows/c73efd374a3be124b1e278866cf366b5e911df4d/MyKVM Local_0.1.3_x64-setup.exe`
- SHA-256：`a50fe23e7f14d176633e8b1e468d8e669544844fba020f4b846c4cbd35b3d087`
- GitHub artifact：`windows-preview-c73efd374a3be124b1e278866cf366b5e911df4d`
- CI：[Actions run 34357658307](https://github.com/akitten-cn/mykvm/actions/runs/34357658307)

Windows Server 2022 runner 通过原生检查和 228 个库测试后生成该 NSIS 安装器。它未签名，尚未在物理 Windows 主机安装或启动。
