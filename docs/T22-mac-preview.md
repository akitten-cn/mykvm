...
- `src-tauri/target/aarch64-apple-darwin/release/bundle/dmg/MyKVM Local_0.1.1_aarch64.dmg`，约 6.6 MiB；`hdiutil verify` 报告校验有效。

应用版本 `0.1.1`，bundle identifier 为 `local.mykvm.gaming`。DMG SHA-256 为 `fc7b7547beaa2cabcef2f656714ee083eb8144659aaebe2f4019366f3efd3ccf`；主程序 SHA-256 为 `86fd805c5b47546e366567ea42a3f80cfeca54c2d5f3f9d1978142b8db8c65a0`。可用 `shasum -a 256 -c docs/PREVIEW_ARTIFACTS.sha256` 复核。
